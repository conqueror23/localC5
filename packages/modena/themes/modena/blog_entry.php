...
<section class="margin-top-120">
    <div class="grid-container">
        <div class="grid-row">
            <?php if($pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar') == 'left' && $pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar') != 'none' || (empty($pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar')))) : ?>
            ...
            <?php endif; ?>
            <div class="<?php echo $pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar') == 'none' ? 'column-12' : 'column-8 push-column-1'; ?>">
                <?php
                    $a = new Area('Main');
            ...
            <?php if($pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar') == 'right' && $pObj->getConfig()->get('site_front_end.blog_sidebar.blog_sidebar') != 'none') : ?>
                <div class="column-3 blog-sidebar">
                    <?php
                        $a = new GlobalArea('Sidebar');
                        $a->display();
