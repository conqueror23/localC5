...
<div class="form-group">
    ...
    <?php  echo Core::make("helper/concrete/asset_library")->image('ccm-b-vidal_themes_lightbox-lightboxLargeImage-' . Core::make('helper/validation/identifier')->getString(18), $view->field('lightboxLargeImage'), t("Choose Image"), $lightboxLargeImage_o); ?>
</div>
...
<div class="form-group">
    ...
    <?php  echo Core::make("helper/concrete/asset_library")->image('ccm-b-vidal_themes_lightbox-lightboxSmallImage-' . Core::make('helper/validation/identifier')->getString(18), $view->field('lightboxSmallImage'), t("Choose Image"), $lightboxSmallImage_o); ?>
</div>
