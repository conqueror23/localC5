...
<div class="ccm-tab-content" id="ccm-tab-content-team-<?php echo $identifier_getString; ?>">
    <div class="form-group">
        ...
        <?php  echo Core::make("helper/concrete/asset_library")->image('ccm-b-vidal_themes_team-profileImage-' . Core::make('helper/validation/identifier')->getString(18), $view->field('profileImage'), t("Choose Image"), $profileImage_o); ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <?php  echo Core::make('editor')->outputBlockEditModeEditor($view->field('profileBio'), $profileBio); ?>
    </div>
    <div class="form-group">
