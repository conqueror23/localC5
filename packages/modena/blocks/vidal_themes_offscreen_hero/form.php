...
<div id="ccm-tab-content-hero-unit-details" class="ccm-tab-content">
    <div class="form-group">
        ...
        <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-vidal_themes_offscreen_hero-heroImage-' . $identifier_getString, $view->field('heroImage'), t("Choose Image"), $heroImage_o); ?>
    </div>
