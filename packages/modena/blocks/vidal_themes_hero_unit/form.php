...
<div class="ccm-tab-content" id="ccm-tab-content-hero-unit-<?php echo $identifier_getString; ?>">
    ...
    <div class="form-group">
        ...
        <?php echo Core::make("helper/concrete/asset_library")->image('ccm-b-vidal_themes_hero_unit-heroUnitBackgroundImage-' . $identifier_getString, $view->field('heroUnitBackgroundImage'), t("Choose Image"), $heroUnitBackgroundImage_o); ?>
    </div>
</div>
