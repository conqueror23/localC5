...
class Controller extends BlockController
{
    ...
    protected function addEdit()
    {
        ...
        $al->register('javascript', 'handlebars', 'blocks/vidal_themes_accordion/js_form/handlebars-v4.0.4.js', array(), 'modena');
        $al->register('javascript', 'handlebars-helpers', 'blocks/vidal_themes_accordion/js_form/handlebars-helpers.js', array(), 'modena');
