        ...
        <div class="header-right">
            <div class="header-nav">
                <ul>
                    ...
                    <li>
                        <a href='<?php echo t('https://www.tradingcup.com/en')?>/qualifiers-2020'>
        <?php echo t('2020 qualifiers') ?>
</a>
            ...
            <div class="mobile-nav" id="mobile-nav-menu">
                <div id="mobile-campaign-dropdown-list">
                    <a href="<?php echo t('https://www.tradingcup.com/en');?>"><?php echo t("home");?></a>
                    <a href="<?php echo t('https://www.tradingcup.com/en');?>/news"><?php echo t("new");?></a>
